...
def volatility_comparison_data(option_symbol, timeframe):
    ...
    historical_volatility_df = get_historical_volatility(underlying_symbol, start_date, timeframe=timeframe)
    historical_implied_volatility_df = get_historical_iv(option_symbol, start_date, timeframe)[["timestamp","mark_iv"]]
