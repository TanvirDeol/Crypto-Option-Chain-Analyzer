...
def get_historical_data(symbol, timeframe, start_str, end_str=None):
    ...
    if timeframe == 1:
        # we convert to 10 minutes at end of function
...
def rollback_date(start_date, timeframe):
    ...
    # Default to 10 minutes if interval is not found
    interval_minutes = interval_mapping.get(interval, 10)
    # Calculate the total minutes to roll back
    total_minutes = 30 * interval_minutes
